module BABYLON {
    ...
    export class CharacterController extends BABYLON.ScriptComponent {
        private static MARGIN_FACTOR:number = -0.04;
        ...
        private _useGhostSweepTest:boolean = false;
        ...
        public getUseSweepTest():any { return this._useGhostSweepTest; }
        ...
        protected awakeMovementState():void {
            ...
            if (world != null) {
                ...
                if (showDebugColliders === true && (<any>this.transform)._debugCollider == null) {
                    ...
                    const debugCapsule:BABYLON.Mesh = BABYLON.MeshBuilder.CreateCapsule(debugName, { tessellation:this._capsuleSegments, subdivisions: 8, capSubdivisions: 16, height: capsuleSize.y, radius: capsuleSize.x }, this.scene);
